...
public class GlideRoundCorner extends BitmapTransformation {
    ...
    public boolean equals(Object o){
        if (o instanceof GlideRoundCorner){
            GlideRoundCorner other = (GlideRoundCorner) o;
